...
OBJS := \
	$(obj).target/$(TARGET)/tools/android/heap_profiler/heap_dump.o
...
$(builddir)/heap_dump: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/heap_dump: LIBS := $(LIBS)
$(builddir)/heap_dump: LD_INPUTS := $(OBJS)
$(builddir)/heap_dump: TOOLSET := $(TOOLSET)
$(builddir)/heap_dump: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/heap_dump
# Add target alias
.PHONY: heap_dump
heap_dump: $(builddir)/heap_dump
