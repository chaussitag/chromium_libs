...
OBJS := \
	$(obj).target/$(TARGET)/tools/android/adb_reboot/adb_reboot.o
...
$(builddir)/adb_reboot: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/adb_reboot: LIBS := $(LIBS)
$(builddir)/adb_reboot: LD_INPUTS := $(OBJS)
$(builddir)/adb_reboot: TOOLSET := $(TOOLSET)
$(builddir)/adb_reboot: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/adb_reboot
# Add target alias
.PHONY: adb_reboot
adb_reboot: $(builddir)/adb_reboot

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/adb_reboot
