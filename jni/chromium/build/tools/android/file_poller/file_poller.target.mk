...
OBJS := \
	$(obj).target/$(TARGET)/tools/android/file_poller/file_poller.o
...
$(builddir)/file_poller: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/file_poller: LIBS := $(LIBS)
$(builddir)/file_poller: LD_INPUTS := $(OBJS) $(obj).target/base/libbase.cr.so
$(builddir)/file_poller: TOOLSET := $(TOOLSET)
$(builddir)/file_poller: $(OBJS) $(obj).target/base/libbase.cr.so FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/file_poller
# Add target alias
.PHONY: file_poller
file_poller: $(builddir)/file_poller

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/file_poller
