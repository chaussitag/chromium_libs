...
OBJS := \
	$(obj).target/$(TARGET)/tools/android/ps_ext/ps_ext.o
...
$(builddir)/ps_ext-unstripped: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/ps_ext-unstripped: LIBS := $(LIBS)
$(builddir)/ps_ext-unstripped: LD_INPUTS := $(OBJS)
$(builddir)/ps_ext-unstripped: TOOLSET := $(TOOLSET)
$(builddir)/ps_ext-unstripped: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/ps_ext-unstripped
# Add target alias
.PHONY: ps_ext-unstripped
ps_ext-unstripped: $(builddir)/ps_ext-unstripped
